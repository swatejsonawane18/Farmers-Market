...
//                        System.out.println("Enter the Category you want to buy in (STRING)-");
                        ...
                        if (!(product.equalsIgnoreCase("INSECTICIDES") || product.equalsIgnoreCase("PESTICIDES") || product.equalsIgnoreCase("CROP SEEDS") || product.equalsIgnoreCase("TOOLS") || product.equalsIgnoreCase("DISPLAY CART") || product.equalsIgnoreCase("BUY CART PRODUCTS") || product.equalsIgnoreCase("EXIT"))) {
                            ...
                            if (product.equalsIgnoreCase("BUY CART PRODUCTS")) {
